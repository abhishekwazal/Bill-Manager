...
const HomePage = () => {
    ...
    const getAllTransactions = async () => {
      try {
        ...
        const res = await axios.get(
          `http://localhost:8000/api/v1/transaction/get-transactions`,
          payload
        );
  ...
  const handleDelete = async (record) => {
    try {
      setLoading(true);
      await axios.post(`http://localhost:8000/api/v1/transection/delete-transactions`, {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      setLoading(true);
      if (editable) {
        await axios.post(`http://localhost:8000/api/v1/transaction/edit-transactions`, {
          payload: {
            ...values
          },
        ...
        await axios.post(`http://localhost:8000/api/v1/transaction/add-transactions`, {
          ...values
        });
        setLoading(false);
        // console.log({
